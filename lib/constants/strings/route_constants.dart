class RouteConstants {
  ...
  static const String player1 = '/folder/:fid/session/:sid';
  static const String folder2Path = '/folder/:fid/folder2/:f2id';
  static const String player2 = '/folder/:fid/folder2/:f2id/session/:sid';
  static const String folder3Path = '/folder/:fid/folder2/:f2id/folder3/:f3id';
  static const String player3 =
      '/folder/:fid/folder2/:f2id/folder3/:f3id/session/:sid';

...
Widget defaultBoxShimmer(BuildContext context) {
  return Center(
    child: BoxShimmerWidget(
      width: context.knobs.double.slider(label: 'Width', initialValue: 300, min: 50, max: 400),
      height: context.knobs.double.slider(label: 'Height', initialValue: 80, min: 20, max: 200),
      borderRadius: context.knobs.double.slider(label: 'Border radius', initialValue: 14, min: 0, max: 32),
    ),
  );
}
